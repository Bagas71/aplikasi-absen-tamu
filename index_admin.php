  ...
  <body>
    <div class="row">
      <div class="col-md-12">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
          <div>
            ...
            <div class="text-warning ml-4">
              <a href="logout.php"><i class="fas fa-sign-out-alt text-warning"  data-toggle="tooltip" data-placement="top" title="Logout"></i></a>   
            </div>
        </nav>
           ...
           <table class="table table-bordered">
              ...
              <tbody class="text-white">
                ...
                <tr>
                  <td scope="row"><?= $i ?></td>
                  <td>
                    <a href="ubah.php?id=<?= $isi['id']; ?>" class="btn btn-dark text-warning">Ubah</a> |
                    <a href="hapus.php?id=<?= $isi['id']; ?>"onclick="return confirm('apakah anda yakin.?')" class="btn btn-secondary text-warning">Hapus</a>
                  </td>
                  <td><?= $isi['nama']; ?></td>
                  <td><?= $isi['asal']; ?></td>
                  <td><?= $isi['alamat']; ?></td>
            ...
            <nav aria-label="Page navigation example " style="float: left;">
              <ul class="pagination ">
                ...
                <?php for ( $i = 1 ; $i <= $jumlahHalaman; $i++) : ?>
                    ...
                    <li class="page-item active"><a class="page-link bg-dark" href="?halaman=<?= $i ; ?>"><?= $i ;  ?></a></li>
                    <?php else : ?>
        ...
        <div class="container">
          <button style="float: right;" type="button" class="btn btn-dark btn-lg"><a href="index.php" class="btn btn-dark text-warning">Tambah Data</a></button>
        </div>
